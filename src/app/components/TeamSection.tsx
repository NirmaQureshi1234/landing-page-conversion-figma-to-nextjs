...
const testimonials = [
  { name: 'James Ndaku', title: 'Software Developer', review: '"Lorem ipsum dolor sit amet, consectetur adipiscing elit. Suspendisse varius enim in eros elementum tristique. Duis cursus, mi quis viverra ornare."', image: "/pic3.png", rating: 5 },
  { name: 'Erick Kipkemboi', title: 'Custom Maker', review: '"Lorem ipsum dolor sit amet, consectetur adipiscing elit. Suspendisse varius enim in eros elementum tristique. Duis cursus, mi quis viverra ornare."', image: "/pic1.png", rating: 4 },
  { name: 'Stephen Kerubo', title: 'UI/UX Designer', review: '"Lorem ipsum dolor sit amet, consectetur adipiscing elit. Suspendisse varius enim in eros elementum tristique. Duis cursus, mi quis viverra ornare."', image: "/pic6.png", rating: 5 },
];
    ...
    <div className="min-h-screen py-12 bg-[#F7F7F7]">
      <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
        <section className="text-center mb-12">
          ...
          <p className="text-[#000000] mb-12 font-roboto">Meet the professionals who make it all happen.</p>
...
<section className="text-center">
  <h2 className="text-4xl font-bold font-roboto mb-8">Customer Testimonials</h2>
  <div className="grid grid-cols-1 sm:grid-cols-2 lg:grid-cols-3 gap-8">
      ...
      <div key={index} className="bg-[#F7F7F7] rounded-lg border-[#676767] border-[1px] pt-[64px] pb-[64px] pr-[32px] pl-[32px] text-center">
        ...
        <div className="flex items-center justify-center">
          ...
          <div className="ml-4 text-left">
            <h3 className="text-lg font-semibold font-roboto">{testimonial.name}</h3>
            <p className="text-[#000000] font-roboto">{testimonial.title}</p>
          </div>
        </div>
      </div>
    ))}
