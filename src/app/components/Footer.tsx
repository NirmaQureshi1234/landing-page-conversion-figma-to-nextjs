...
const Footer = () => {
        ...
        <>
            <div className='mt-32 flex flex-col sm:flex-row items-center justify-evenly px-4 sm:px-0'>
                <div className='mb-6 sm:mb-0 text-center sm:text-left'>
                    <h1 className='font-bold font-robototext-[18px] sm:text-[20px]'>Subscribe to our newsletter</h1>
                    <p className='text-[16px] sm:text-[18px] font-roboto'>Lorem ipsum dolor sit amet, consectetur adipiscing elit.</p>
                </div>
    ...
    <div className='flex flex-col sm:flex-row items-center sm:items-start'>
        ...
        />
        <button className='border border-[#676767] w-full sm:w-[119px] h-[48px] rounded font-roboto'>Subscribe</button>
    </div>
        ...
        By subscribing you agree to our Privacy Policy
            ...
            <div className='flex flex-col sm:flex-row items-center justify-evenly mt-28 px-4 sm:px-0'>
                ...
                <div className='text-center sm:text-left mb-6 sm:mb-0'>
                    <h1 className='font-bold text-[16px] sm:text-[18px] font-roboto'>Courses</h1>
                ...
                <div className='text-center sm:text-left mb-6 sm:mb-0'>
                    <h1 className='font-bold text-[16px] sm:text-[18px] font-roboto'>Resources</h1>
                    ...
                    <h4 className='text-sm sm:text-base font-roboto'>Interview Preparation</h4>
                    <h4 className='text-sm sm:text-base font-roboto'>Jobs</h4>
                </div>
                <div className='text-center sm:text-left'>
                    <h1 className='font-bold text-[16px] sm:text-[18px] font-roboto'>About Us</h1>
                    ...
                    <h4 className='text-sm sm:text-base font-roboto'>Terms and Conditions</h4>
            ...
            <div className='flex flex-col sm:flex-row items-center justify-between mt-10 mx-10 pb-24'>
                ...
                <div className='flex space-x-4 text-sm sm:text-base mb-4 sm:mb-0'>
                    <h4 className='cursor-pointer hover:underline font-roboto'>Privacy Policy</h4>
                    <h4 className='cursor-pointer hover:underline font-roboto'>Terms of Service</h4>
                    <h4 className='cursor-pointer hover:underline font-roboto'>Cookies Settings</h4>
                </div>
            ...
            <a href="#" className="text-[#000000] hover:text-[#676767]"><FaFacebook size={24} /></a>
            <a href="#" className="text-[#000000] hover:text-[#676767]"><FaInstagram size={24} /></a>
            <a href="#" className="text-[#000000] hover:text-[#676767]"><FaTwitter size={24} /></a>
             <a href="#" className="text-[#000000] hover:text-[#676767]"><FaLinkedin size={24} /></a>
          </div>
            </div>
        </>
    )
